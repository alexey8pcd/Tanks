...
import ru.ovcharov_alexey.tanks.v4.engine.units.actions.AttackMultishells;
...
public class AttackActionFactory {
    ...
    public static final AttackAction UNIT_ATTACK_ACTION_MILTISHELLS = new AttackMultishells();
    ...
    public static AttackAction createAttackAction(String className) {
        ...
        } else if (AttackMultishells.class.getCanonicalName().equals(className)) {
            return UNIT_ATTACK_ACTION_MILTISHELLS;
        } else {
